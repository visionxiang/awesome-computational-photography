...
|   CVPR   | LoFTR: Detector-Free Local Feature Matching with Transformers |                                                              | [Paper](https://arxiv.org/abs/2104.00680)/[Code](https://github.com/zju3dv/LoFTR)<br>[Proj](https://zju3dv.github.io/loftr/) |
...
|   2019   |   BMVC   | Video Stitching for Linear Camera Arrays <span style="color:darkblue;">`CNNStitch`</span> | Wei-Sheng Lai, et al.                                        | [Paper](https://jankautz.com/publications/VideoStitching_BMVC19.pdf)/[arXiv](https://arxiv.org/abs/1907.13622)<br>[Proj](http://vllab.ucmerced.edu/wlai24/video_stitching/) |
